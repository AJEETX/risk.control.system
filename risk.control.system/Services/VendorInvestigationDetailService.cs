...
{
    public interface IVendorInvestigationDetailService
    {
    ...
    internal class VendorInvestigationDetailService: IVendorInvestigationDetailService
    {
        private readonly ILogger<VendorInvestigationDetailService> logger;
        private readonly ApplicationDbContext context;
        private readonly ICustomApiClient customApiCLient;
        private readonly ITimelineService timelineService;

        public VendorInvestigationDetailService(
            ILogger<VendorInvestigationDetailService> logger, 
