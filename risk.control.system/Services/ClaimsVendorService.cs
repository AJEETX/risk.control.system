...
//            model = new ClaimsInvestigationVendorsModel { InvestigationReport = claim.InvestigationReport, Location = claim.BeneficiaryDetail, ClaimsInvestigation = claim };
...
//            {
//                claim.InvestigationReport.SupervisorRemarks = null;
//            }
//            var isClaim = claim.PolicyDetail.InsuranceType == InsuranceType.CLAIM;
...
//            return (new ClaimsInvestigationVendorsModel { InvestigationReport = claim.InvestigationReport, Location = beneficiaryDetails, ClaimsInvestigation = claim });
//        }
