$(function () {
    ...
    var table = $("#dataTable").DataTable({
        ajax: {
            url: '/api/Company/GetEmpanelledAgencyNew/' + claimId,
            dataSrc: '',
        ...
        columns: [
            ...
            },
            {
                ...
                "mRender": function (data, type, row) {
                    ...
                    return '<span class="blue" title="' + row.name + '" data-bs-toggle="tooltip">' + data + '</span>' + '<br /> ' + img;
                }
            },
            {
                "sDefaultContent": "",
    ...
    function showagencydetail(id, element) {
        ...
        const url = `/Claim/AgencyProfile/${encodeURIComponent(id)}?selectedcase=${claimId}`;
