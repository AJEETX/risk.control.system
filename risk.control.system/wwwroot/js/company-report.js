$(document).ready(function () {
    ...
    $("#customerTable").DataTable({
        ajax: {
            url: '/api/CompanyCompletedClaims/GetReport',
            dataSrc: ''
        },
        order: [[11, 'asc']],
        fixedHeader: true,
        ...
        columns: [
            ...
            { "data": "timePending" },
            {
                ...
                "mRender": function (data, type, row) {
                    var buttons = "";
                    buttons += '<a onclick="showdetails()" href="/Report/Detail?Id=' + row.id + '" class="btn btn-xs btn-info"><i class="fa fa-search"></i> Detail</a>&nbsp;'
