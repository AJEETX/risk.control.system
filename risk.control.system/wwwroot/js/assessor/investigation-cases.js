$(document).ready(function () {
    var table = $("#dataTable").DataTable({
        ajax: {
            url: '/api/Assessor/GetInvestigationReports',
            type: 'GET',
            dataType: 'json',
        ...
        columnDefs: [
            ...
            {
                className: 'max-width-column-name', // Apply the CSS class,
                targets: 13                      // Index of the column to style
            },
            {
        ...
        columns: [
            ...
            },
            {
                ...
                "mRender": function (data, type, row) {
                    ...
                    img += '<img src="' + row.ownerDetail + '" class="profile-image doc-profile-image" title="' + row.agent + '" data-bs-toggle="tooltip"/>'; // Thumbnail image with class 'thumbnail'
