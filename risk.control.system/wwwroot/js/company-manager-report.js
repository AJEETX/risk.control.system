$(document).ready(function () {
    ...
    $("#customerTable").DataTable({
        ajax: {
            url: '/api/CompanyCompletedClaims/GetManagerReport',
            dataSrc: ''
        },
        order: [[11, 'asc']],
        fixedHeader: true,
        ...
        columns: [
            ...
            },
            {
                ...
                "mRender": function (data, type, row) {
                    var buttons = "";
                    buttons += '<a id="details' + row.id + '" onclick="getdetails(`' + row.id + '`)" href="/Report/ApprovedDetail?Id=' + row.id + '" class="btn btn-xs btn-info"><i class="fa fa-search"></i> Detail</a>&nbsp;'
