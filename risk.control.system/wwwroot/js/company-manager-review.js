$(document).ready(function () {
    ...
    $("#customerTable").DataTable({
        ajax: {
            url: '/api/CompanyActiveClaims/GetManagerReview',
            dataSrc: ''
        },
        order: [[12, 'desc']],
        fixedHeader: true,
        ...
        columns: [
            ...
            },
            {
                ...
                "mRender": function (data, type, row) {
                    var buttons = "";
                    buttons += '<a id="details' + row.id + '" onclick="getdetails(`' + row.id + '`)"  href="ManagerReviewDetail?Id=' + row.id + '" class="active-claims btn btn-xs btn-info"><i class="fa fa-search"></i> Detail</a>&nbsp;'
