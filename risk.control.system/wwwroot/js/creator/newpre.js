    ...
    var table = $("#customerTableAuto").DataTable({
        ...
        columns: [
            ...
            },
            {
                ...
                "mRender": function (data, type, row) {
                    var buttons = "";
                    buttons += '<a id="assign' + row.id + '" href="Assign?Id=' + row.id + '" class="btn btn-xs btn-info"><i class="fas fa-external-link-alt"></i> Assign</a>&nbsp;'
                    buttons += '<a id="edit' + row.id + '" href="Edit?Id=' + row.id + '" class="btn btn-xs btn-warning"><i class="fas fa-pencil-alt"></i> Edit</a>&nbsp;'
