        ...
        columns: [
            ...
            },
            {
                ...
                "mRender": function (data, type, row) {
                    ...
                    img += '<img data-title="Customer: ' + row.customerFullName + '" data-img="' + row.customer + '" src="' + row.customer + '" class="thumbnail table-profile-image open-map-modal" title="' + row.customerFullName + '" data-bs-toggle="tooltip">'; // Thumbnail image with class 'thumbnail'
                    img += '</div>';
                    return img;
                }
            },
