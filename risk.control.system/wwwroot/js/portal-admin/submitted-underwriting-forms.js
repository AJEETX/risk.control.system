$(document).ready(function () {
    ...
    $.ajax({
        url: '/AddAssign/GetUnderwritingSubmissionsJson',
        type: 'GET',
...
function showedit(id, element) {
    ...
    const editUrl = `/AddAssign/EditUnderwritingForm/${encodeURIComponent(id)}`;
...
function showdetail(id, element) {
    ...
    const editUrl = `/Creator/GetEmpanelledAgencies/${encodeURIComponent(id)}`;
