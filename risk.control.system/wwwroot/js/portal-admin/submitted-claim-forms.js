$(document).ready(function () {
    ...
    $.ajax({
        url: '/Form/GetClaimSubmissionsJson',
        type: 'GET',
    ...
    return `
        <div class="p-3 bg-light border rounded shadow-sm m-2">
            <div class="row">
                ...
                <div class="col-md-4 border-end">
                    <h6 class="text-success border-bottom pb-2 fw-bold">Nominee Details</h6>
                    ${nomineeHtml || '<p class="text-muted small">No data</p>'}
                </div>
                <div class="col-md-4">
                    <h6 class="text-danger border-bottom pb-2 fw-bold">Claim Details</h6>
