$(document).ready(function () {
        ...
        columns: [
            ...
            data file source */
            {
                ...
                "mRender": function (data, type, row) {
                    var img = '<input name="id" class="selected-case" type="radio" id="' + row.id + '"  value="' + row.id + '"  data-toggle="tooltip" title="Select Case" />';
                    return img;
                }
            },
            {
    ...
    $('#allocatedcase').on('click', function () {
        ...
        if (id) {
            ...
            window.location.href = 'GetInvestigate/' + id;
        } else {
