$(document).ready(function () {
    ...
    $("#customerTable").DataTable({
        ajax: {
            url: '/api/CompanyCompletedClaims/GetManagerReject',
            dataSrc: ''
        },
        order: [[12, 'desc']],
        fixedHeader: true,
        ...
        columns: [
            ...
            },
            {
                ...
                "mRender": function (data, type, row) {
                    var buttons = "";
                    buttons += '<a id="details' + row.id + '" onclick="getdetails(`' + row.id + '`)" href="/Report/ManagerRejectDetail?Id=' + row.id + '" class="btn btn-xs btn-info"><i class="fa fa-search"></i> Detail</a>&nbsp;'
