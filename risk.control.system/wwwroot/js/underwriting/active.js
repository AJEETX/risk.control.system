...
function initDynamicDataTable(dynamicFields, submissionsData) {
                    ...
                    return `
                        <div class="d-flex align-items-center justify-content-between gap-2 text-start px-1">
                            ...
                            <a href="${mapUrl}" target="_blank" class="btn btn-xs btn-outline-danger py-0 px-2 text-nowrap shadow-sm" title="Open in Google Maps">
                                <i class="fa fa-geo text-danger me-1"></i>Map
                            </a>
                        </div>`;
                }
    ...
    columnsConfig.push(
        ...
        render: function (data) {
            return data
                ? `<span class="small bold"> ${data}</span>`
...
function formatChildPanel(rowData) {
            ...
            if (f.isAddress) {
                return `
                    <div class="mb-2">
                        ...
                        ${f.mapUrl ? `<a href="${f.mapUrl}" target="_blank" class="btn btn-xs btn-outline-indigo py-0 px-2 mt-1 shadow-sm btn-xs-map"><i class="fa fa-geo-alt-fill me-1"></i>View Map</a>` : ''}
                    </div>`;
            }
            return `
                <div class="mb-2">
    ...
    const policyDocHtml = policyFile ? `
        <div class="border rounded p-3 text-center bg-light d-flex flex-column align-items-center justify-content-center h-100 doc-preview-box">
            ...
            <a href="${policyFile.url}" target="_blank" class="btn btn-xs btn-outline-primary text-nowrap py-1 px-2 small">
                <i class="fa fa-paperclip me-1"></i>Policy Document
            </a>
        </div>` : `
        <div class="border rounded p-3 text-center bg-light d-flex flex-column align-items-center justify-content-center h-100 doc-preview-box">
    ...
    const claimDocHtml = claimFile ? `
        <div class="border rounded p-3 text-center bg-light d-flex flex-column align-items-center justify-content-center h-100 doc-preview-box">
            ...
            <a href="${claimFile.url}" target="_blank" class="btn btn-xs btn-outline-primary text-nowrap py-1 px-2 small">
                <i class="fa fa-paperclip me-1"></i>Claim Document
            </a>
        </div>` : `
        <div class="border rounded p-3 text-center bg-light d-flex flex-column align-items-center justify-content-center h-100 doc-preview-box">
        ...
        <div class="p-3 bg-light border rounded shadow-sm m-2">
            <div class="row g-3">
                ...
                <div class="col-lg-4">
                    <div class="card h-100 border shadow-sm rounded-2 overflow-hidden">
                        <div class="card-header bg-white border-bottom py-2 d-flex align-items-center">
                            <i class="fa fa-journal-text text-primary fs-5 me-2"></i>
                            <h6 class="mb-0 fw-semibold text-dark">Policy Details</h6>
                        </div>
                ...
                <div class="col-lg-4">
                    <div class="card h-100 border shadow-sm rounded-2 overflow-hidden">
                        <div class="card-header bg-white border-bottom py-2 d-flex align-items-center">
                            <i class="fa fa-person-plus text-success fs-5 me-2"></i>
                            <h6 class="mb-0 fw-semibold text-dark">Nominee Details</h6>
                        </div>
                        <div class="bg-success text-white px-2 py-1 d-flex justify-content-between align-items-center card-ribbon-bar">
                            <i class="fa fa-bookmark-fill"></i>
                ...
                <div class="col-lg-4">
                    <div class="card h-100 border shadow-sm rounded-2 overflow-hidden">
                        <div class="card-header bg-white border-bottom py-2 d-flex align-items-center">
                            <i class="fa fa-clipboard-data text-warning fs-5 me-2"></i>
                            <h6 class="mb-0 fw-semibold text-dark">Claim Details</h6>
                        </div>
                        <div class="bg-success text-white px-2 py-1 d-flex justify-content-between align-items-center card-ribbon-bar">
                            <i class="fa fa-bookmark-fill"></i>
