...
app.Use(async (context, next) =>
{
    ...
    context.Response.Headers.Add("Content-Security-Policy",
        ...
        "script-src 'strict-dynamic' 'self' https://maps.googleapis.com https://polyfill.io https://highcharts.com https://export.highcharts.com https://cdnjs.cloudflare.com; " +
