...
namespace risk.control.system.Seeds
{
    public static class UnderwritingQuestion
    {
        public static List<Question> QuestionsUNDERWRITING_LA_ADDRESS()
        {
            ...
            var question11 = QuestionSeed.Q("Financial Status of Life Assured (Please mention your observation basis life style etc.) ?", "dropdown", true, "LOWER CLASS,LOWER- MIDDLE CLASS,MIDDLE CLASS, UPPER CLASS, UNKNOWN");
            ...
            var question14 = QuestionSeed.Q("Employment Category (Salaried /Self employed etc.) ?", "dropdown", true, "SALARIED, SELF-EMPLOYED, CASUAL-CONTRACTOR, GOVT-EMPLOYED, UNKNOWN");
            ...
            var question17 = QuestionSeed.Q("Vicinity Check Details – met person Name/Mobile number and details confirmed ?", "text", true);
            var question18 = QuestionSeed.Q("Date and time met with Person ?", "date", true);
            var question19 = QuestionSeed.Q("Any Other findings ?", "text");
