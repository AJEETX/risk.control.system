...
namespace risk.control.system.Seeds
{
    public static class AssessorSeed
    {
        ...
        {
            string assessorImagePath = Path.Combine(env.WebRootPath, "seed", Path.GetFileName(photo));
            ...
            if (userManager.Users.All(u => u.Id != clientAssessor.Id))
            {
                ...
                if (user == null)
                {
                    ...
                    await userManager.AddToRoleAsync(clientAssessor, ASSESSOR.DISPLAY_NAME);
                }
            }
        }
    }
