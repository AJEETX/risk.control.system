    ...
    public class ClaimsVendorController : Controller
    {
        ...
        public async Task<IActionResult> GetInvestigate(string selectedcase)
        {
            ...
            if (claimCase.ClaimReport.LocationLongLat != null)
            {
                ...
                var url = $"https://maps.googleapis.com/maps/api/staticmap?center={longLatString}&zoom=14&size=200x200&maptype=roadmap&markers=color:red%7Clabel:S%7C{longLatString}&key=AIzaSyDXQq3xhrRFxFATfPD4NcWlHLE8NPkzH2s";
