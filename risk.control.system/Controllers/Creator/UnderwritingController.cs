...
namespace risk.control.system.Controllers.Creator
{
    ...
    public class UnderwritingController : Controller
    {
        ...
        public UnderwritingController(ILogger<UnderwritingController> logger,
        ...
        [Breadcrumb("Add")]
        [HttpGet]
        public IActionResult Add(InsuranceType type = InsuranceType.UNDERWRITING)
        {
        ...
        [HttpGet]
        [Breadcrumb("Edit", FromAction = nameof(Assign))]
        ...
        private string GetSampleFieldValue(FormField field, string policyNumber)
        {
