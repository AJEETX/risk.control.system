...
//{
//    public class UnderwritingInvestigationPostController : Controller
//    {
...
//        public UnderwritingInvestigationPostController(ApplicationDbContext context,
...
//                var (policy,status) = await claimsInvestigationService.AllocateToVendor(currentUserEmail, claimId, selectedcase, false);
...
//                await mailboxService.NotifyClaimAllocationToVendor(currentUserEmail, policy, claimId, selectedcase);
