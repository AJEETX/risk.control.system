...
namespace risk.control.system.Controllers.Company
{
    ...
    public partial class UnderwritingController : Controller
    {
        ...
        private readonly IUnderwritingService claimPolicyService;

        public UnderwritingController(ApplicationDbContext context,
            ...
            IUnderwritingService claimPolicyService)
        {
            _context = context;
        ...
        public async Task<IActionResult> EditPolicy(string id)
        {
            ...
            try
            {
                ...
                var claimsPage = new MvcBreadcrumbNode("New", "CreatorAuto", UNDERWRITING);
