...
namespace risk.control.system.Controllers.Company
{
    ...
    public class AvailableAgencyUserController : Controller
    {
        ...
        public async Task<IActionResult> CreateUser(long id)
        {
            ...
            var editPage = new MvcBreadcrumbNode("CreateUser", "AvailableAgencyUser", $"Add User") { Parent = usersPage };
            ViewData["BreadcrumbNode"] = editPage;
        ...
        public async Task<IActionResult> CreateUser(ApplicationUser model, string emailSuffix)
        {
            ...
            catch (Exception ex)
            {
                ...
                return RedirectToAction(nameof(CreateUser), "AvailableAgencyUser", new { id = model.VendorId });
            }
        }
        ...
        public async Task<IActionResult> EditUser(long userId)
        {
            ...
            try
            {
                ...
                var editPage = new MvcBreadcrumbNode("EditUser", "AvailableAgencyUser", $"Edit User") { Parent = usersPage };
                ViewData["BreadcrumbNode"] = editPage;
        ...
        public async Task<IActionResult> DeleteUser(long userId)
        {
            ...
            try
            {
                ...
                var editPage = new MvcBreadcrumbNode("DeleteUser", "AvailableAgencyUser", $"Delete User") { Parent = usersPage };
                ViewData["BreadcrumbNode"] = editPage;
