...
namespace risk.control.system.Controllers.Company
{
    ...
    public class AvailableAgencyServiceController : Controller
    {
        ...
        public IActionResult Service(long id)
        {
            ...
            var serviceMainLink = new MvcBreadcrumbNode("AvailableVendors", "AvailableAgency", "Manager Agency(s)");
            var serviceSecondLink = new MvcBreadcrumbNode("AvailableVendors", "AvailableAgency", "Available Agencies") { Parent = serviceMainLink };
