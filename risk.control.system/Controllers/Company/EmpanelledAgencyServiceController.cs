...
namespace risk.control.system.Controllers.Company
{
    ...
    public class EmpanelledAgencyServiceController : Controller
    {
        ...
        [Breadcrumb("Manage Service", FromAction = "AgencyDetail", FromController = typeof(EmpanelledAgencyController))]
        ...
        public async Task<IActionResult> CreateService(long id)
        {
            try
            {
                ...
                var detailsPage = new MvcBreadcrumbNode("AgencyDetail", "EmpanelledAgency", $"Agency Profile") { Parent = agencyPage, RouteValues = new { id = id } };
                var editPage = new MvcBreadcrumbNode("Service", "EmpanelledAgencyService", $"Manage Service") { Parent = detailsPage, RouteValues = new { id = id } };
                var addPage = new MvcBreadcrumbNode("CreateService", "EmpanelledAgencyService", $"Add Service") { Parent = editPage };
        ...
        public async Task<IActionResult> EditService(long id)
        {
            ...
            try
            {
                ...
                var addPage = new MvcBreadcrumbNode("EditService", "EmpanelledAgencyService", $"Edit Service") { Parent = editPage };
                ViewData["BreadcrumbNode"] = addPage;
