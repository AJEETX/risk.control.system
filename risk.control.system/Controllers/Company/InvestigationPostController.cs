    ...
    public class InvestigationPostController : Controller
    {
        ...
        public async Task<IActionResult> CreatePolicy(InvestigationTask model)
        {
            try
            {
                ...
                if (model == null || model.PolicyDetail == null || model.PolicyDetail.InsuranceType == null || model.PolicyDetail.InvestigationServiceTypeId == 0 || model.PolicyDetail.CostCentreId == 0 ||
