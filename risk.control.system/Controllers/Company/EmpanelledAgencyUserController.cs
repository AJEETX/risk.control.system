...
namespace risk.control.system.Controllers.Company
{
    public class EmpanelledAgencyUserController : Controller
    {
        ...
        [Breadcrumb(" Manage Users", FromAction = "AgencyDetail", FromController = typeof(EmpanelledAgencyController))]
        public IActionResult AgencyUsers(string id)
        {
            ViewData["vendorId"] = id;

            var claimsPage = new MvcBreadcrumbNode("EmpanelledVendors", "EmpanelledAgency", "Manage Agency(s)");
            var agencyPage = new MvcBreadcrumbNode("EmpanelledVendors", "EmpanelledAgency", "Empanelled Agencies") { Parent = claimsPage, };
            ...
            var editPage = new MvcBreadcrumbNode("AgencyUsers", "EmpanelledAgency", $"Manage Users") { Parent = detailsPage, RouteValues = new { id = id } };
        ...
        public async Task<IActionResult> CreateAgencyUser(long id)
        {
            ...
            if (vendor == null)
            {
                ...
                return RedirectToAction(nameof(AgencyUsers), "EmpanelledAgencyUser", new { id = id });
            }
            ...
            var agencyPage = new MvcBreadcrumbNode("EmpanelledVendors", "EmpanelledAgency", "Empanelled Agencies") { Parent = claimsPage, };
            var detailsPage = new MvcBreadcrumbNode("AgencyDetail", "EmpanelledAgency", $"Agency Profile") { Parent = agencyPage, RouteValues = new { id = id } };
            var editPage = new MvcBreadcrumbNode("AgencyUsers", "EmpanelledAgencyUser", $"Manage Users") { Parent = detailsPage, RouteValues = new { id = id } };
            var addPage = new MvcBreadcrumbNode("CreateAgencyUser", "EmpanelledAgencyUser", $"Add user") { Parent = editPage };
        ...
        public async Task<IActionResult> CreateAgencyUser(ApplicationUser model, string emailSuffix)
        {
            ...
            return RedirectToAction(nameof(AgencyUsers), "EmpanelledAgencyUser", new { id = model.VendorId });
        }
        ...
        public async Task<IActionResult> EditAgencyUser(long? userId)
        {
            ...
            try
            {
                ...
                var claimsPage = new MvcBreadcrumbNode("EmpanelledVendors", "EmpanelledAgency", "Manage Agency(s)");
                var agencyPage = new MvcBreadcrumbNode("EmpanelledVendors", "EmpanelledAgency", "Empanelled Agencies") { Parent = claimsPage, };
                var detailsPage = new MvcBreadcrumbNode("AgencyDetail", "EmpanelledAgency", $"Agency Profile") { Parent = agencyPage, RouteValues = new { id = vendorApplicationUser.VendorId } };
                var editPage = new MvcBreadcrumbNode("AgencyUsers", "EmpanelledAgencyUser", $"Manage Users") { Parent = detailsPage, RouteValues = new { id = vendorApplicationUser.VendorId } };
                var addPage = new MvcBreadcrumbNode("EditAgencyUser", "EmpanelledAgencyUser", $"Edit user") { Parent = editPage };
                ViewData["BreadcrumbNode"] = addPage;
        ...
        public async Task<IActionResult> DeleteAgencyUser(long userId)
        {
            ...
            try
            {
                ...
                var claimsPage = new MvcBreadcrumbNode("EmpanelledVendors", "EmpanelledAgency", "Manage Agency(s)");
                var agencyPage = new MvcBreadcrumbNode("EmpanelledVendors", "EmpanelledAgency", "Empanelled Agencies") { Parent = claimsPage, };
                var detailsPage = new MvcBreadcrumbNode("AgencyDetail", "EmpanelledAgency", $"Agency Profile") { Parent = agencyPage, RouteValues = new { id = model.VendorId } };
                var editPage = new MvcBreadcrumbNode("AgencyUsers", "EmpanelledAgencyUser", $"Manage Users") { Parent = detailsPage, RouteValues = new { id = model.VendorId } };
                var addPage = new MvcBreadcrumbNode("DeleteAgencyUser", "EmpanelledAgencyUser", $"Delete user") { Parent = editPage };
                ViewData["BreadcrumbNode"] = addPage;
        ...
        public async Task<IActionResult> DeleteAgencyUser(string email, long vendorId)
        {
            ...
            return RedirectToAction(nameof(AgencyUsers), "EmpanelledAgencyUser", new { id = vendorId });
        }
    }
}