...
namespace risk.control.system.Controllers.Agency
{
    ...
    public class VendorQueryController : Controller
    {
        ...
        private readonly ILogger<VendorQueryController> logger;
        private readonly ApplicationDbContext _context;
        private readonly IBackgroundJobClient backgroundJobClient;

        public VendorQueryController(
            ...
            ILogger<VendorQueryController> logger,
        ...
        public async Task<IActionResult> ReplyQuery(long claimId, CaseInvestigationVendorsModel request, IFormFile? document)
        {
            ...
            try
            {
                ...
                var claim = await processCaseService.SubmitQueryReplyToCompany(userEmail, claimId, request.InvestigationReport.EnquiryRequest, request.InvestigationReport.EnquiryRequests, document);
