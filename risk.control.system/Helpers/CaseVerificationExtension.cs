...
{
    public static class CaseVerificationExtension
    {
        public static string GetCreatorPreTimePending(this CaseVerification a, bool active = false, bool review = false)
        {
            if (!active)
            {
                if(a.CreatorSla == 0)
        ...
        public static string GetAgentPreTimePending(this CaseVerification a, bool open = false)
        {
        ...
        public static string GetSupervisorPreTimePending(this CaseVerification a, bool newClaim = false, bool taskedToAgent = false, bool submitted = false, bool completed = false, bool enquiry = false)
        {
        ...
        public static string GetAssessorPreTimePending(this CaseVerification a, bool assess = false,bool processed= false, bool enquiry = false, bool review = false)
        {
        ...
        public static string GetManagerPreTimePending(this CaseVerification a, bool assess= false, bool completed = false)
        {
        ...
        public static string GetPolicy(this CaseVerification a)
        {
            var claim = a;
        ...
        public static string GetPolicyPreNum(this CaseVerification a)
        {
            var claim = a;
            if (claim is not null)
            {
        ...
        public static string GetPolicyPreNumForAgency(this CaseVerification a, string id)
        {
            var claim = a;
            if (claim is not null)
            {
        ...
        public static string GetPincodePre(ClaimType? claimType, Claimant cdetail, BeneficiaryDetail location)
        {
        ...
        public static string GetPersonPrePhoto(ClaimType? claimType, Claimant cdetail, BeneficiaryDetail beneficiary)
        {
            if (claimType == ClaimType.HEALTH)
            {
        ...
        public static string GetPincodePreName(ClaimType? claimType, Claimant cdetail, BeneficiaryDetail location)
        {
            if (claimType == ClaimType.HEALTH)
            {
                if (cdetail is null)
        ...
        public static string GetElapsedPreTime(this List<CaseVerificationTransaction> caseLogs)
        {
